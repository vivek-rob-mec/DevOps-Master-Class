# PHP Inventory Management Modular Monolith - Dependencies

| Area | Template | Production requirement |
|---|---|---|
| Backend | PHP 8.3 / Slim / PostgreSQL | Patch pin, lockfile, license/provenance/vulnerability review |
| Frontend | Vue 3 / Vite | Lockfile, CSP, browser policy, scanning |
