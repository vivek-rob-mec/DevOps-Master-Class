# Python Learning Management Modular Monolith - HLD

## Scope and architecture

The **Modular monolith** owns the learning critical journey. It prioritizes correctness, secure boundaries, reversible delivery, observable outcomes, and a path from Compose to Kubernetes.
