# Node.js Booking Microservices Platform - HLD

## Scope and architecture

The **Microservices** owns the booking critical journey. It prioritizes correctness, secure boundaries, reversible delivery, observable outcomes, and a path from Compose to Kubernetes.
