# Rust Payment Risk and Transactional Outbox Service - HLD

## Scope and architecture

The **Event-driven cloud service** owns the payment-risk critical journey. It prioritizes correctness, secure boundaries, reversible delivery, observable outcomes, and a path from Compose to Kubernetes.
