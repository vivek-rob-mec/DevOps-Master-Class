# Rust Payment Risk and Transactional Outbox Service - Dependencies

| Area | Template | Production requirement |
|---|---|---|
| Backend | Rust 1.97 / Axum / Tokio / PostgreSQL / NATS JetStream | Patch pin, lockfile, license/provenance/vulnerability review |
