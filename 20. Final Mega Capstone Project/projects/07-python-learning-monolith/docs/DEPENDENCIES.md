# Python Learning Management Modular Monolith - Dependencies

| Area | Template | Production requirement |
|---|---|---|
| Backend | Python 3.12 / FastAPI / PostgreSQL | Patch pin, lockfile, license/provenance/vulnerability review |
| Frontend | Server-rendered HTML / progressive JavaScript | Lockfile, CSP, browser policy, scanning |
