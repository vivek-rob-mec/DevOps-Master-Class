# Rails Subscription Billing Monolith - HLD

## Scope and architecture

The **Convention-driven modular monolith** owns the billing critical journey. It prioritizes correctness, secure boundaries, reversible delivery, observable outcomes, and a path from Compose to Kubernetes.
