# Rails Subscription Billing Monolith - Dependencies

| Area | Template | Production requirement |
|---|---|---|
| Backend | Ruby 3.4 / Rails 8.1 / PostgreSQL | Patch pin, lockfile, license/provenance/vulnerability review |
| Frontend | Rails views / Hotwire | Lockfile, CSP, browser policy, scanning |
