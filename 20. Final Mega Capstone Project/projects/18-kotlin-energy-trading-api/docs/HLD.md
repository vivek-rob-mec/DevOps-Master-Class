# Kotlin Reactive Energy Trading Service - HLD

## Scope and architecture

The **Reactive enterprise service** owns the energy-trading critical journey. It prioritizes correctness, secure boundaries, reversible delivery, observable outcomes, and a path from Compose to Kubernetes.
