# .NET Insurance Claims Modular Monolith - Dependencies

| Area | Template | Production requirement |
|---|---|---|
| Backend | .NET 10 LTS / ASP.NET Core / PostgreSQL | Patch pin, lockfile, license/provenance/vulnerability review |
| Frontend | ASP.NET static web application | Lockfile, CSP, browser policy, scanning |
